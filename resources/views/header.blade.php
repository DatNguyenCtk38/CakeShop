		...
		<div class="header-body">
			<div class="container beta-relative">
				...
				<div class="pull-right beta-components space-left ov">
					...
					@if(Session::has('cart'))
						<div class="cart">
							<div class="beta-select"><i class="fa fa-shopping-cart"></i> <span class="gio-hang-tb">Giỏ hàng (@if(Session::has('cart')){{Session('cart')->totalQty}}
							@else Trống @endif)</span> <i class="fa fa-chevron-down"></i></div>
